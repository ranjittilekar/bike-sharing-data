...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = error ## Here as its a regression problem we are not using error*final_outputs(1-final_outputs) as                                              sigmoid is not used in the output layer
